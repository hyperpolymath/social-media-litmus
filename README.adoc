...
> Automated system to monitor social media platform policies and deliver 3-monthly guidance to NUJ members

[![CI]()](https://github.com/Hyperpolymath/social-media-dipstick/actions/workflows/ci.yml)
...
=== Data Layer
- ArangoDB 15+ with TimescaleDB for time-series data
...
./tools/cli/restore.sh backups/nuj_monitor_20250101_120000.aql.gz
```
...
=== Training (confidential/year)
- Social media ethics workshops
- Platform policy webinars

=== Union Licensing (£15k/year)
- TUC unions: confidential/year
- International unions: confidential/year

=== API Access (confidential/year)
